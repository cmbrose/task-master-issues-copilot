const { loadConfig } = require('./scripts/config-management');
...
try {
  const config = loadConfig({
    ...
    maxArtifactsCount: parseInt(process.env.INPUT_MAX_ARTIFACTS_COUNT),
    retentionDays: parseInt(process.env.INPUT_RETENTION_DAYS)
  });
